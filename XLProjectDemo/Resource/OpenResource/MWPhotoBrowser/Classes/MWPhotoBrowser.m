...
//        [self.navigationController.navigationBar setBarTintColor:[UIColor colorWithRed:45/255.0 green:105/255.0 blue:165/255.0 alpha:0.5]];
        
//        [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:@"grow_nav_bg"] forBarMetrics:UIBarMetricsDefault];
//        设置导航栏背景
        [self.navigationController.navigationBar setBackgroundImage:[UIImage imageNamed:[NSString stringWithFormat:@"header_bg%@" ,kIOS7 ? @"_ios7" : @""]] forBarMetrics:UIBarMetricsDefault];
    }
