...
//        [SCCommon saveImageToPhotoAlbum:image];
        ...
        CGFloat headHeight = _previewLayer.bounds.size.height - squareLength -  CAMERA_HEIGHT_AUTO;//_previewLayer的frame是(0, 44, 320, 320 + 44)
        CGSize size = CGSizeMake(squareLength * 2, (squareLength + headHeight + CAMERA_HEIGHT_AUTO)  * 2);
...
- (void)switchGrid:(BOOL)toShow {
    ...
    CGFloat headHeight = _previewLayer.bounds.size.height - SC_APP_SIZE.width - CAMERA_HEIGHT_AUTO;
    CGFloat squareLength = SC_APP_SIZE.width+ CAMERA_HEIGHT_AUTO;
